...
### GIF/SVG 파일로 export
원하면 [asciinema gif generator](https://github.com/asciinema/agg) 툴을 사용하여 움직이는 GIF 파일로 export 시킬 수 있다.  
또, [svg-term-cli](https://github.com/marionebl/svg-term-cli) 툴을 사용하면 SVG 파일로도 export 시킬 수 있다.
