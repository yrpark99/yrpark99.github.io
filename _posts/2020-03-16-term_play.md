...
<script>AsciinemaPlayer.create('/assets/cast/demo.cast', document.getElementById('asciinema-player'), {cols: 100, rows: 18, poster: 'npt:0:30', fit: false, terminalFontSize: "medium", terminalFontFamily: "D2 Coding"});</script>
