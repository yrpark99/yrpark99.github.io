...
이후 다시 dirtyfail 툴로 스캔하면 이전과 동일한 항목들이 VULNERABLE 하다고 표시되지만, 실제로 exploit 테스트를 해 보면 기대대로 exploit이 실패하였다. 👍
...
> 최근에 KISA에서 AI 보안 위협과 관련하여 아래 문서를 배포하였다.
> - [AI 보안 위협 대응 매뉴얼](https://www.kisa.or.kr/401/form?postSeq=3712)
> - [AI 보안 레드티밍 가이드](https://www.kisa.or.kr/401/form?postSeq=3713)
>
> AI 보안 위협에 관심이 있다면 읽어보는 것도 좋겠다.
