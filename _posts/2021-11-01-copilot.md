...
정식 서비스인 경우에도 두 달 동안은 무료 평가판으로 사용할 수 있으므로 앞으로도 두 달 동안은 무료로 사용할 수 있긴 한데, 이 기간이 끝나고 Copilot을 무료로 못 쓰게 되는 경우에는 [Kite](https://www.kite.com/), [Tabnine](https://www.tabnine.com/) 등으로 다시 돌아가야 할 것 같다. 😭
