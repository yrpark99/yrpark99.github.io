...
> Copilot이 유료로 전환된 관계로, 대신에 2023년부터는 주로 [ChatGPT](https://chat.openai.com/)를 사용해서 코딩 관련 도움을 받고 있다. 참고로 ChatGPT를 이용할 때, 웹브라우저 이외에도 VS Code에서는 [ChatGPT](https://marketplace.visualstudio.com/items?itemName=gencay.vscode-chatgpt) 등의 익스텐션을 사용하면 편리하다.
