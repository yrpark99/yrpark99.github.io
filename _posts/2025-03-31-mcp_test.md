...
## MCP 소개
MCP는 Claude를 개발한 Anthropic에서 2024년 11월에 오픈소스로 발표한 AI의 맥락을 위한 프로토콜로, LSP(Language Server Protocol)에서 영감을 받아서 개발하였다고 한다.  
...
* [Visual Studio Code](https://code.visualstudio.com/)
  ...
  * [Copilot-MCP](https://marketplace.visualstudio.com/items?itemName=AutomataLabs.copilot-mcp), [GitHub Copilot Chat](https://marketplace.visualstudio.com/items?itemName=GitHub.copilot-chat) 익스텐션
...
## 맺음말
MCP가 발표되고 나서 많은 MCP 서버/클라이언트 등이 만들어졌는데, 사용자는 덕분에 AI를 이용하여 좀 더 세밀하게 원하는 작업을 할 수 있게 되었다 (마치 개인 비서를 둔 것처럼).  
