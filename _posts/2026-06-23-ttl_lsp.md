...
VS Code 용 LSP 익스텐션을 작성하려면 [VSCode 익스텐션 - Language Server Extension Guide](https://pg-vscode-extn-kr.github.io/api/language-extensions/language-server-extension-guide/) 문서를 봐야 한다.  
...
- [VS Code 마켓](https://marketplace.visualstudio.com/items?itemName=yrpark99.teraterm-ttl-lsp)
