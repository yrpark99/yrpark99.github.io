...
<script>AsciinemaPlayer.create('/assets/cast/nand_simul.cast', document.getElementById('nand_simul'), {cols: 134, rows: 30, poster: 'npt:0:45', fit: false, terminalFontSize: "medium"});</script>
