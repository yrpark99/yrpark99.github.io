...
<script>AsciinemaPlayer.create('/assets/cast/python_cross_build.cast', document.getElementById('python_cross_build'), {cols: 134, rows: 25, poster: 'npt:3:55', fit: false, terminalFontSize: "medium"});</script>
