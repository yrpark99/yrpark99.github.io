...
```
물론 Microsoft Store에서 Linux로 검색해서 나오는 배포판을 선택하여 설치할 수 있고, 보통은 이게 더 편리한 방법이다.

<br>
또한 Microsoft Store에 없는 배포판을 설치할 수도 있다. GitHub에서 이런 배포판 프로젝들을 찾아볼 수 있었는데 예를 들어, 아래 배포판 프로젝트들이 있다.
- [Manjaro WSL](https://github.com/sileshn/ManjaroWSL)
- [Mint WSL](https://github.com/sileshn/LinuxmintWSL)
